<section class="bg-base-content/10 rounded-3xl">
        ...
        <div class="flex flex-col md:flex-row justify-center items-center md:items-start gap-6">
            @foreach ($steps as $index => $step)
                ...
                @if ($index < count($steps) - 1)
                    <svg class="shrink-0 w-12 fill-base-content opacity-70 {{ $index % 2 === 0 ? 'max-md:-scale-x-100 md:-rotate-90' : 'md:-scale-x-100 md:-rotate-90' }}" viewBox="0 0 138 138" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
